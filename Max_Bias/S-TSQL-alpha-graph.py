...
if __name__ == "__main__":
    ...
    file1 = open("./ProbLeft-S-TSQL_1", "rb")
    file2 = open("./ProbLeft-S-TSQL_2", "rb")
    #file3 = open("./ProbLeft-check_5", "rb")
    # file4 = open("./ProbLeft-sql", "rb")
    file5 = open("./ProbLeft-S-TSQL_3", "rb")
    file9 = open("./ProbLeft-S-TSQL_4", "rb")
    ...
    # print(var1)
    plt.errorbar(x, mean1, 2 * var1, fmt='r--', capsize=2.5, errorevery=10, markevery=10, label=r"S-TSQL-$\alpha_n=\frac{40}{(n+100)^{0.6}}$")
    plt.errorbar(x, mean2, 2 * var2, fmt='b--', capsize=2.5, markevery=10, errorevery=10, label=r"S-TSQL-$\alpha_n=\frac{1}{n+1}$")
    ...
    plt.errorbar(x, mean5, 2 * var5, fmt='g--', capsize=2.5, markevery=10, errorevery=10,
                  label=r"S-TSQL-$\alpha_n=\frac{10}{n+100}$")
    plt.errorbar(x, mean9, 2 * var9, fmt='y--', capsize=2.5, markevery=10, errorevery=10,
                  label=r"S-TSQL-$\alpha_n=\frac{40}{n+100}$")
    ...
    plt.tight_layout()
    plt.savefig('S-TSQL-alpha_mar18.pdf', dpi=600, bbox_inches='tight')
    plt.close()
