...
if __name__ == "__main__":
    ...
    # print(var1)
    plt.errorbar(x, mean1, 2 * var1, fmt='r--', capsize=2.5, errorevery=10, markevery=10, label=r"TSQL-$\alpha_n=\frac{40}{(n+100)^{0.6}}}$")
    plt.errorbar(x, mean2, 2 * var2, fmt='b--', capsize=2.5, markevery=10, errorevery=10, label=r"TSQL-$\alpha_n=\frac{1}{n+1}$")
    ...
    plt.tight_layout()
    plt.savefig('TSQL-alpha_mar18.pdf', dpi=600, bbox_inches='tight')
    plt.close()
